...
class Converter:
    ...
    def __init__(self):
        ...
        instructions = "Please enter a temperature below and " \
                       ...
                       "it from centigrade to Farenheit. "
    ...
    def check_temp(self, min_value):
        ...
        # labels can correctly formatted by formatting function
        if has_error == "yes":
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        help_text = "To use the program, simply enter the temperature " \
                    ...
                    "to either degree Celsius (centigrade) or " \
                    "Fahrenheit.. \n\n" \
...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        self.hist_export_label = Label(self.history_frame,
                                     text="History / Export",
                                     font=("Arial", "16", "bold"),
                                     width=25)
        self.hist_export_label.grid(row=0)
        ...
        if num_calcs > max_calcs:
            ...
            showing_all = "Here are your recent calculations " \
                          ...
                          "your " \
                          "calculations to see your full calculations " \
    ...
    def get_calc_string(self, var_calculations):
        ...
        # adding item and line break to calculations string
    ...
    # retrieves date and creates YYY_MM_DD string
    def get_date(self):
        today = date.today()
    ...
    # check filename onl has letters, numbers
    # amd underscores
    @staticmethod
